...
if (isset($_GET['id'])) {
    ...
    if ($id_para_excluir == $_SESSION['usuario_id']) {
        echo "<script>alert('Não pode excluir a sua própria conta!'); window.location.href='cadastro.php';</script>";
        exit;
    }
    ...
    try {
        ...
        echo "<script>alert('Utilizador excluído com sucesso!'); window.location.href='cadastro.php';</script>";
